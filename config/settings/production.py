...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["api.instarchiver.net"])
CSRF_TRUSTED_ORIGINS = [
    "https://api.instarchiver.net",
]
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Instarchiver <noreply@api.instarchiver.net>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [
    {"url": "https://api.instarchiver.net", "description": "Production server"},
]
# Your stuff...
# ------------------------------------------------------------------------------
